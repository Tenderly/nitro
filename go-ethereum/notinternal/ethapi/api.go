...
import (
	...
	"github.com/tenderly/nitro/go-ethereum/accounts/scwallet"
	...
	"github.com/tenderly/nitro/go-ethereum/consensus/misc/eip1559"
...
func (s *EthereumAPI) FeeHistory(
	ctx context.Context,
	blockCount math.HexOrDecimal64,
	lastBlock rpc.BlockNumber,
	rewardPercentiles []float64,
) (*feeHistoryResult, error) {
	oldest, reward, baseFee, gasUsed, err := s.b.FeeHistory(
		ctx,
		uint64(blockCount),
		lastBlock,
		rewardPercentiles,
...
func (s *PersonalAccountAPI) signTransaction(
	ctx context.Context,
...
//
// https://github.com/tenderly/nitro/go-ethereum/wiki/Management-APIs#personal_sign
func (s *PersonalAccountAPI) Sign(
	ctx context.Context,
	data hexutil.Bytes,
	addr common.Address,
	passwd string,
...
//
// https://github.com/tenderly/nitro/go-ethereum/wiki/Management-APIs#personal_ecRecover
...
func (s *BlockChainAPI) GetHeaderByNumber(
	ctx context.Context,
...
func (s *BlockChainAPI) arbClassicL1BlockNumber(
	ctx context.Context,
	block *types.Block,
) (hexutil.Uint64, error) {
...
// a `BlockchainAPI`.
func (s *BlockChainAPI) rpcMarshalBlock(
	ctx context.Context,
	b *types.Block,
	inclTx bool,
	fullTx bool,
...
func AccessList(
	...
	precompiles := vm.ActivePrecompiles(
		b.ChainConfig().
			Rules(header.Number, isPostMerge, header.Time, types.DeserializeHeaderExtraInformation(header).ArbOSFormatVersion),
	)
...
func (s *TransactionAPI) GetBlockTransactionCountByNumber(
	ctx context.Context,
	blockNr rpc.BlockNumber,
) *hexutil.Uint {
	if block, _ := s.b.BlockByNumber(ctx, blockNr); block != nil {
...
func (s *TransactionAPI) GetBlockTransactionCountByHash(
	ctx context.Context,
	blockHash common.Hash,
) *hexutil.Uint {
	if block, _ := s.b.BlockByHash(ctx, blockHash); block != nil {
...
func (s *TransactionAPI) GetTransactionByBlockNumberAndIndex(
	ctx context.Context,
	blockNr rpc.BlockNumber,
	index hexutil.Uint,
) *RPCTransaction {
...
func (s *TransactionAPI) GetTransactionCount(
	ctx context.Context,
	address common.Address,
	blockNrOrHash rpc.BlockNumberOrHash,
) (*hexutil.Uint64, error) {
...
func (s *TransactionAPI) GetRawTransactionByHash(
	ctx context.Context,
	hash common.Hash,
) (hexutil.Bytes, error) {
...
func (s *TransactionAPI) GetTransactionReceipt(
	ctx context.Context,
	hash common.Hash,
) (map[string]interface{}, error) {
	found, tx, blockHash, blockNumber, index, err := s.b.GetTransaction(ctx, hash)
...
func marshalReceipt(
	...
	if backend.ChainConfig().IsArbitrum() {
		...
		if backend.ChainConfig().IsArbitrumNitro(header.Number) {
			...
			fields["l1BlockNumber"] = hexutil.Uint64(
				types.DeserializeHeaderExtraInformation(header).L1BlockNumber,
			)
		} else {
			inner := tx.GetInner()
...
func (s *TransactionAPI) FillTransaction(
	ctx context.Context,
	args TransactionArgs,
) (*SignTransactionResult, error) {
...
func (api *DebugAPI) GetRawReceipts(
	ctx context.Context,
	blockNrOrHash rpc.BlockNumberOrHash,
) ([]hexutil.Bytes, error) {
	var hash common.Hash
...
func checkTxFee(gasPrice *big.Int, gas uint64, cap float64) error {
	...
	feeEth := new(
		big.Float,
	).Quo(new(big.Float).SetInt(new(big.Int).Mul(gasPrice, new(big.Int).SetUint64(gas))), new(big.Float).SetInt(big.NewInt(params.Ether)))
