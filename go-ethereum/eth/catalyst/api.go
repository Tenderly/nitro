...
import (
	...
	"github.com/tenderly/nitro/go-ethereum/beacon/engine"
	...
	"github.com/tenderly/nitro/go-ethereum/params/forks"
...
func (api *ConsensusAPI) ForkchoiceUpdatedV2(update engine.ForkchoiceStateV1, params *engine.PayloadAttributes) (engine.ForkChoiceResponse, error) {
	if params != nil {
		...
		if api.eth.BlockChain().Config().LatestFork(params.Timestamp, types.DeserializeHeaderExtraInformation(api.eth.BlockChain().CurrentHeader()).ArbOSFormatVersion) != forks.Shanghai {
